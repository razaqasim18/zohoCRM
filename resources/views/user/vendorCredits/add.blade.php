                ...
                <form action="{{ route('customer.insert') }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>New Vendor Credits</h4>
                            <div class="card-header-action">
                                <a href="{{ route('vendorCredits.list') }}" class="btn btn-primary">
                                    All Vendor Credits
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="cnote">Credit Note#</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control" id="cnote">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="vcreditdate">Vendor Credit Date</label>
                                    <input type="date" class="form-control" name="vcreditdate" id="vcreditdate">
                                </div>
                            </div>
                        </div>
        ...
        <div class="form-row">
            ...
            <div class="col-md-6">
                <div class="form-group m-0">
                    ...
                    <div class="row">
                        <div class="form-group col-md-8">
                            <h5 class="text-left">Discount ( PKR )</h5>
                        </div>
                        <div class="form-group col-md-4">
                            <h5 class="text-right" id="label_sub_total_amount">0.0</h5>
                        </div>
